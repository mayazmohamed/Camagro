...
<div class="container mx-auto mt-8 bg-black rounded-3xl">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <img src="https://via.placeholder.com/150" alt="User Profile" class="w-64 h-64 rounded-full mx-auto mb-2">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="first_name" value="<?= htmlspecialchars($first_name) ?>" class="w-full rounded border p-2">
            </div>

            <!-- Last Name -->
            <div class="mb-4">
                <label for="last_name" class="block font-semibold text-white underline">Last Name:</label>
                <input type="text" name="last_name" value="<?= htmlspecialchars($last_name) ?>" class="w-full rounded border p-2">
            </div>
            ...
            <!-- Submit Button -->
            <div class="mb-4">
            <button type="button" class="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Submite Changes</button>
            </div>
        </form>
    </div>
    <div class="w-full ">
